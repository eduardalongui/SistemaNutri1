<p style="color:#fff">registrar</p>
<html>
    <head>
<title>Vida saudável</title>
    <link href="teste2.css" rel="stylesheet" type="text/css" />
    <link href="registrar.js" rel="javascript" type="text/javascript" />
    <meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />

</head>
<body>
    <form id="form1" method="post" action="TeacherOperations">
...
<div id="quote">
<h3 style="color: #792533; font-family: Georgia, Georgia, serif; font-weight: normal;">Cadastre-se, Usuário</h3>                     
    <table style="margin-top: 1px; ">
                        <tr>
                            <td style="color: #792533;font-family: Georgia, Georgia, serif; font-weight: normal;">
                                Nome
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Button ID="Button1" runat="server" Text="Cadastrar-se" OnClick="Button1_Click" />
                                <input type="submit" value="Cadastre-se" name="Cadastrar-se"/>
                            </td>
                    </table>
</div>
