...
<title>Vida saudável</title>
    ...
    <link href="login.jsp" rel="javascript" type="text/javascript" />
    <meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
</head>
<body>
        <form id="form1" method="post" action="LoginPessoa">
...
<h3 style="color: #792533; font-family: Georgia, Georgia, serif; font-weight: normal;">Faça seu login</h3>
	<ul>
		        <table>
                            <tr>
                       ...
                       <td>
                        <input type="text" name="loginPessoa" value="" />
                       </td>
                            </tr>
                        <tr>
                        <td style="color: #792533;font-family: Georgia, Georgia, serif; font-weight: normal;">
                        ...
                        <td>
                        <input type="password" name="senhaPessoa" value="" />
                        </td>
                        </tr>
                            <td>
